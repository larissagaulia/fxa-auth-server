    ...
    },
    {
      ...
      handler: function (request, reply) {
            ...
            .then(
              function (result) {
                ...
                if (! requestHelper.shouldEnableTokenVerification(emailRecord, config, request)) {
                  ...
                  doSigninConfirmation = requestHelper.wantsKeys(request) && emailRecord.emailVerified
                }
        ...
        function sendNewDeviceLoginNotification() {
          ...
          shouldSendNewDeviceLoginEmail &= requestHelper.wantsKeys(request)
          shouldSendNewDeviceLoginEmail &= ! doSigninConfirmation
          shouldSendNewDeviceLoginEmail &= emailRecord.emailVerified
